...
import {
  ...
  Calendar, Reply, Info, File,
  Trash2, AlertTriangle, Check, X, PanelRightOpen,
  MessageCircle, Maximize, Minimize
} from 'lucide-react';
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1 text-sm">Manage chats and support tickets</p>
        </div>
