              ...
              <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
                ...
                {detail.return_notes && (
                  <div className="mt-3 pt-3 border-t border-amber-200/60">
                    <p className="text-[10px] font-bold uppercase text-amber-700 tracking-wider mb-1">Customer Details</p>
                    <p className="text-sm text-amber-900">{detail.return_notes}</p>
                  </div>
                )}
              </div>

              {/* Admin Note */}
              {detail.return_admin_note && (
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <MessageSquare className="w-4 h-4 text-slate-600" />
                    <p className="text-xs font-bold uppercase text-slate-600 tracking-wider">Admin Note</p>
                  </div>
                  <p className="text-sm text-slate-700 italic">"{detail.return_admin_note}"</p>
                </div>
              )}
