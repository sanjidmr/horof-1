  ...
  return (
    <div className="space-y-8">
        <div className="flex items-center gap-3">
          <div className="h-14 w-14 rounded-2xl bg-[#E6F0EB] text-[#1a4731] flex items-center justify-center shrink-0 shadow-sm">
            <Palette className="h-7 w-7" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-slate-900">My Design Requests</h1>
