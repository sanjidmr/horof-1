...
export function FreeShippingManager({ initial }: { initial: FreeShippingOffer[] }) {
  ...
  const handleSave = async () => {
    ...
    const payload: any = {
      ...
      starts_at: formData.starts_at ? new Date(`${formData.starts_at}T00:00:00`).toISOString() : null,
      expires_at: formData.expires_at ? new Date(`${formData.expires_at}T23:59:59.999`).toISOString() : null,
