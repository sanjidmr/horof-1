          ...
          <div className="bg-gradient-to-br from-[#1a4731] to-[#0d2b1d] rounded-[1.75rem] p-6 text-white shadow-xl shadow-forest-900/20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3">
                <Link href="/admin/products/new" className="flex items-center gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors">
                  <Package className="w-4 h-4 text-emerald-400" />
                  <span className="text-sm font-medium">Add New Product</span>
                </Link>
                <Link href="/admin/orders" className="flex items-center gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors">
                  <ShoppingBag className="w-4 h-4 text-emerald-400" />
                  <span className="text-sm font-medium">View Orders</span>
                </Link>
                <Link href="/admin/messages" className="flex items-center gap-3 p-3 rounded-xl bg-white/10 hover:bg-white/20 transition-colors">
                  <Users className="w-4 h-4 text-emerald-400" />
                  <span className="text-sm font-medium">Messages ({recentMessages.length})</span>
                </Link>
              </div>
            </div>
          </div>
